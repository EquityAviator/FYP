...
export const DARK_PATTERN_CATEGORIES: COCOCategory[] = [
  ...
  {
    id: 4,
    name: 'Disguised Ad / Bait & Switch',
    supercategory: 'dark_pattern',
  },
  { id: 5, name: 'Reference Pricing', supercategory: 'dark_pattern' },
  { id: 6, name: 'False Hierarchy', supercategory: 'dark_pattern' },
  {
    id: 7,
    name: 'Bundling / Auto-add / Bad Defaults',
    supercategory: 'dark_pattern',
  },
  {
    id: 8,
    name: 'Pressured Selling / FOMO / Urgency',
    supercategory: 'dark_pattern',
  },
  ...
  {
    id: 11,
    name: 'Trick Questions / Confirmshaming',
    supercategory: 'dark_pattern',
  },
